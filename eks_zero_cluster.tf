module "eks_zero" {
  ...
  source = "github.com/kbst/terraform-kubestack//aws/cluster?ref=v0.15.0-beta.0"
  ...
  configuration = {
    ...
    apps = {
      ...
      base_domain = "kbst.letsdotech.dev"
      ...
      cluster_availability_zones = "eu-central-1a,eu-central-1b"
    }
